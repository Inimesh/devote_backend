...
class ReceiverAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create receiver_account' do
    assert_difference('ReceiverAccount.count') do
      post receiver_accounts_url,
           params: { receiver_account: { account_name: @receiver_account.account_name, account_no: @receiver_account.account_no, sort_code: @receiver_account.sort_code, user_id: @receiver_account.user_id } }, as: :json
    end
  ...
  test 'should update receiver_account' do
    patch receiver_account_url(@receiver_account),
          params: { receiver_account: { account_name: @receiver_account.account_name, account_no: @receiver_account.account_no, sort_code: @receiver_account.sort_code, user_id: @receiver_account.user_id } }, as: :json
    assert_response :success
  end
